...
SECRET_KEY = 'django-insecure-))mv$5yy!(6_+2&bm=(ded8t(izv%#8p(9hcy3fmn_^yr@*u3z'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                # ф-ия Python, кторая принимает объект request и возвращает
                # словарь, который добавляется в контекст запроса
